                        ...
                        <div className="container">
                            <div className="field">
                                ...
                                <div className="select">
                                    <select id="lang" defaultValue="python3" onChange={changeTemplate}>
                            ...
                            <div className="field">
                                <div className="control">
                                    <textarea id="code" className="textarea is-small is-family-code" spellCheck="false" rows={15}
                            ...
                            <div className="field">
                                <div className="control">
                                    <button id="execute" className="button is-primary is-fullwidth"
                                        onClick={execute}>Run</button>
                                </div>
                            </div>
                    </div>
                    </section>
